...
// Page de la liste des devoirs (FR)
const PageListeDevoirs = async ({
  searchParams,
}: {
  ...
  // Fonction d'affichage d'une ligne du tableau des devoirs
  const afficherLigne = (item: ListeDevoir) => (
    <tr
      key={item.id}
  ...
  // Conditions via paramètres d'URL
...
export default PageListeDevoirs;
