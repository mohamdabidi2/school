...
const PageListeExamens = async ({
  ...
  // Fonction d'affichage d'une ligne du tableau d'examens
  const afficherLigne = (item: ListeExamen) => (
    <tr
      key={item.id}
  ...
  // Conditions spécifiques selon le rôle de l'utilisateur
  switch (role) {
    case "admin":
      break;
    case "teacher":
  ...
  // Requête à la base de données pour récupérer les examens correspondants et le nombre total
...
export default PageListeExamens;
